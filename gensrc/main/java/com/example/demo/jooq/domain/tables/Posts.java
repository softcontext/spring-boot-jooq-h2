...
public class Posts extends TableImpl<PostsRecord> {
    ...
    private static final long serialVersionUID = 1003953479;
     ...
     */
    public final TableField<PostsRecord, Integer> ID = createField("ID", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("(NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_4AF602A7_CE7E_4888_B21C_BF4BEB1F8E1C)", org.jooq.impl.SQLDataType.INTEGER)), this, "");
