...
import com.example.demo.jooq.domain.Public;
...
public class Comments extends TableImpl<CommentsRecord> {
    ...
    private static final long serialVersionUID = -916518702;
     ...
     */
    public final TableField<CommentsRecord, Integer> ID = createField("ID", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("(NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_FADCFE88_5BCF_46FA_AB9F_038AAA5CBF25)", org.jooq.impl.SQLDataType.INTEGER)), this, "");
